    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <?php
        ...
        foreach ($offers as $offer) {
          echo "
          <div key='{$offer['id']}' class='bg-white rounded-lg overflow-hidden shadow-lg border transition-all duration-300 hover:scale-105 hover:shadow-2xl'>
            ...
            <div class='p-6'>
              ...
              <div class='grid grid-cols-2 gap-4'>
                <a href='food_ordering.php' class='bg-blue-500 text-white py-2 px-4 rounded-full border-2 border-transparent hover:border-red-500 hover:bg-black transition duration-300'>View Menu</a>
                <a href='reservation.php' class='bg-green-500 text-white py-2 px-4 rounded-full border-2 border-transparent hover:border-red-500 hover:bg-black transition duration-300'>Reserve Now</a>
              </div>
            </div>
          </div>";
        }
  ...
  <div class="container mx-auto px-4">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <button class="bg-primary text-white py-2 px-6 rounded-full border-2 border-transparent hover:border-red-500 hover:bg-white transition duration-300">Inquire About Corporate Packages</button>
      </div>
      <div class="rounded-lg overflow-hidden shadow-xl">
        <!-- Updated corporate dining image -->
        <img src="https://plus.unsplash.com/premium_photo-1663091215026-81fd5e7653d7?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Corporate event setting" class="w-full h-full object-cover"/>
      </div>
    </div>
  </div>
</section>
